"""Ingestion Agent — LangGraph pipeline for one or many PDFs."""
...
def _ingest_one(
    ...
    *,
    ...
    try:
        ...
        doc_id = str(uuid4())
        source_key = object_store.upload(path, doc_id=doc_id, version=1)
        chunks = chunk_document(parsed)
        chunks = embed_chunks(chunks, checkpoint_key=doc_id)
