#!/usr/bin/env bash
# Resonance Technologies - guided AWS setup for the lab.
...
bold "Resonance Technologies - AWS setup check"
echo
...
if ! aws sts get-caller-identity >/dev/null 2>&1; then
    ...
    err "You need an Access Key ID and Secret. Region: us-east-1 is fine for the lab."
    exit 1
fi
...
echo "  Probing the models we use in the lab..."
