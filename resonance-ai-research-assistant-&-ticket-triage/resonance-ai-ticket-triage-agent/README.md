...
Sibling Project 1 (research assistant) lives in [`../resonance-ai-research-assistant/`](../resonance-ai-research-assistant/) and typically shares `.env`.  
...
Canonical HLA/LLA: [`docs/architecture.md`](docs/architecture.md) (no separate `SYSTEM_DESIGN.md` in this package). See [`AS_BUILT.md`](AS_BUILT.md) for locked decisions, memory details, and verification checklist.
...
- Shared **`.env`** from `../resonance-ai-research-assistant/.env` (or a local `.env`)
...
```bash
cd resonance-ai-ticket-triage-agent
uv sync
# Env loads from ./ .env or ../resonance-ai-research-assistant/.env (override=True)
```
...
```
resonance-ai-ticket-triage-agent/
├── app/
...
| Cursor rules | [`../resonance-ai-research-assistant/.cursor/rules/project2-ticket-triage.mdc`](../resonance-ai-research-assistant/.cursor/rules/project2-ticket-triage.mdc) |
| Shared env | [`../resonance-ai-research-assistant/.env`](../resonance-ai-research-assistant/.env) |
| Project 1 (Research Assistant) | [`../resonance-ai-research-assistant/`](../resonance-ai-research-assistant/) |
